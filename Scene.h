...
private:
  ...
  camera_;                     //!< Camera to render the image with.
  std::vector<std::shared_ptr<Object>>
                                    objects_;       //!< Collection of Objects in the Scene.
  std::vector<std::shared_ptr<LightSource>>
                                         lights_;   //!< Collection of LightSources in the Scene.
   ...
   */
  bool isInShadowFromLight(const Point &point,
